...
export const ImprovedMaximizedMovieCard = memo(({
  ...
  return (
    <>
      ...
      >
        <Card className="w-full max-w-4xl h-full max-h-[90vh] overflow-hidden shadow-2xl bg-gray-900 border-gray-700 flex flex-col">
          {/* Header */}
          <CardHeader className="flex flex-row items-center justify-between space-y-0 p-4 bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-pink-600/20 backdrop-blur-sm border-b border-gray-700 flex-shrink-0">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-semibold text-white">Featured Movie</span>
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            {/* Right side - Content */}
            <CardContent className="w-1/2 p-6 space-y-4 bg-gray-800 overflow-y-auto">
              {/* Title and basic info */}
              <div>
                <h3 className="text-3xl font-bold mb-2 text-white" title={title}>
                  {title}
                </h3>
